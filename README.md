...
เก็บข้อมูลมาจาก "ไทยรัฐ" ทั้งหมด 517923 บทความ (10/02/2562) <br>
ใช้ ทั้ง CBOW และ skip-gram model แล้วเปรียบเทียบกัน (ฝึกโดยเทั้งหัวข้อและนื้อหาบทความ)

### 1.1 python toolkit
tokenizer: `pythainlp.tokenize.word_tokenize` <br>
word2vec: `gensim.model.word2vec` sg=0,1(CBOW, skip-gram), size=300 (มิติ), min_count=5, window=15, epoch=5 <br>
...
กังหันลม 0.4441
  ...
  <td>
    <pre>
met2.similar('ปลาดิบ', 20)
อาทิตย์อุทัย 0.6907
กิมจิ 0.6454
ญี่ปุ่น 0.6113
ซามูไร 0.5951
ประเทศญี่ปุ่น 0.5916
ชาวญี่ปุ่น 0.5641
ยุ่น 0.5567
โอกะ 0.541
เกะ 0.5281
...
<tr>
  <td>
    <pre>
met1.similar('จำหน่าย', 5)
ขาย 0.6141
จัดจำหน่าย 0.5879
วางขาย 0.5715
ผู้จำหน่าย 0.5406
ตัวแทนจำหน่าย 0.5206
    </pre>
  </td>
  <td>
    <pre>
met2.similar('จำหน่าย', 5)
ผู้จำหน่าย 0.6233
ขาย 0.5929
สินค้า 0.5901
ท้องตลาด 0.5897
...
|สูตร|CBOW |Skip-gram |
|:-:|:-:|:-:|
| เกาหลีใต้ + ปลาดิบ - ญี่ปุ่น | กิมจิ 0.6977<br>อาทิตย์อุทัย 0.6380<br>โสมขาว 0.6069 ... |โสมขาว 0.6772<br>กิมจิ 0.6575<br>โสมแดง 0.5454 ... |
| อังกฤษ + ซามูไร - ญี่ปุ่น | ผู้ดี 0.6234<br>เวลส์ 0.5486<br>ดัตช์ 0.4997 ... | ผู้ดี 0.6259<br>คำราม 0.5681<br>พรีเมียร์ 0.5646 ... |
| โปรตุเกส + ปลาดิบ - ญี่ปุ่น | ฝอยทอง  0.6339<br>มะกะโรนี 0.6073<br>แซมบ้า 0.5926 ... | ฝอยทอง 0.617<br>โรนัลโด 0.5412<br>สแปนิช 0.5204 ... |
|อิตาลี + มังกร - จีน | มักกะโรนี 0.4729<br>กระทิง 0.4460<br>ฝอยทอง 0.4292 ... | มะกะโรนี 0.4903<br>มิลาน 0.4867<br>กัลโช 0.4793 ... |

##### 3.1.2.2 วิธี 2 ค้นหา country
|สูตร|CBOW |Skip-gram |
|:-:|:-:|:-:|
|'มะกะโรนี' + 'ญี่ปุ่น' - 'ปลาดิบ' | อิตาลี 0.5970<br>จีน 0.5282<br>อังกฤษ 0.5239 ... |อิตาลี 0.6510<br>ฝรั่งเศส 0.5528<br>ตุรกี 0.5299 ... |
